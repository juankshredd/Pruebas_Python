...
userBalance = input('What is the starting balance for thisaccount? ')
...
for accountNumber in accountsDict:
    print(accountNumber)
    
        
print(accountsDict.values(), type(accountsDict.values()))
#print(json.dumps(accountsDict, sort_keys=False, indent=4))
